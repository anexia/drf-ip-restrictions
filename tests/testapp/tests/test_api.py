...
class TestApi(TestCase):
    def setUp(self):
        ...
        self.partially_private_info = PartiallyPrivateInfo.objects.create(name="partially_private1")
    ...
    @override_settings(DRF_IP_RESTRICTION_SETTINGS={"ALLOWED_IP_LIST": ["200.200.200.200"]})
